...
export function WebsiteCard({ title, description, imageSource }) {
  ...
  return (
    <div 
      className={`flex flex-col items-center justify-center gap-2 rounded-lg border-2 border-white backdrop-blur-sm p-2 py-3 text-center text-white cursor-pointer hover:-translate-y-2 hover:scale-105 hover:ease-in-out hover:shadow-[0_0_8px_5px_rgba(0,114,255,0.8)] active:scale-100 hover:duration-300 transition-all duration-300
