...
export default function Footer(){
    return(
        <footer className="text-white border-2 z-20 sm:mx-8 md:mx-16">
        ...
        <div className="my-6 w-auto text-center duration-200 sm:mb-9">
          <Link href={"/"}>
            <button className="h-10 w-10 rounded-full text-lg text-[#5793fa] hover:shadow-[0_0_8px_5px_rgba(0,114,255,0.8)] border-2 duration-200 ease-out hover:-translate-y-2 sm:h-14 sm:w-14 md:mb-12 md:h-20 md:w-20"></button>
          </Link>
        </div>
      </footer>
    )
